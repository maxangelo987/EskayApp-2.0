...
###################################################################################################
def main():
    #imgTrainingNumbers = cv2.imread("TRAIN_ᜀO.jpg")            # read in training numbers image
    imgTrainingNumbers = cv2.imdecode(np.fromfile('TRAIN_1O.jpg', dtype=np.uint8), cv2.IMREAD_UNCHANGED)
    ...
    intClassifications = []         # declare empty classifications list, this will be our list of how we are classifying our chars from user input, we will write to file at the end
                                    ...
                                    # possible chars we are interested, put these in list intValidChars
