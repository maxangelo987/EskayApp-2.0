for x in range(360):
    y = 'Synthetic_Data_Creation/ESKAYA-A/rotatedwhite' + str(x)  +'.png'
    ...
    def main():
        ...
        try:
            ...
            print("error, unable to open classifications.npy, exiting program\n")
            os.system("pause")
            return
        # end try

        try:
            npaFlattenedImages = np.load("FLATTENED_IMAGES.npy")  # read in training images
        except:
            print("error, unable to open flattened_images.npy, exiting program\n")
            os.system("pause")
            return
        # end try
        ...
        imgTestingNumbers = cv2.imread(y)  # read in testing numbers image
